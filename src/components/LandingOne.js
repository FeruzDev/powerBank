        ...
        return (
            <div className="LandingOne">
                ...
                <div className="PairTwo">
                    <h1>Yoou Share <span>Yoou Share</span></h1>
                    <Container fluid={true}>
                        <Row>
                            <Col md={4}>
                    ...
                    <Container fluid={true}>
                        <Row>
                            ...
                            <Col md={8}>
                                ...
                                <h1 className="pairThreeTitle2">Характеристики <span>power bank</span></h1>
                                <p>Емкость: 5000 mAh
                                    Разъемы: Apple, Android
                                    Размер: 180х85х15 мм
                                    Вес: 0,2 кг <span><img src="./photos/Union.svg" alt=""/></span></p>
                            </Col>
                        </Row>
                    </Container>
                </div>
                <div className="PairFour">
                    <Container fluid={true}>
                        <Row>
                            ...
                            <Col md={4}>
                                <div className="leftImg">
                                    <img src="./photos/Group 124 (1).png" alt=""/>
                                </div>
                            </Col>
                        </Row>
                    </Container>
